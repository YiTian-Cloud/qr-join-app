...
export default function ThanksgivingClinicPage() {
  //
  // Match the same QR logic as your landing page
  //
  const rawBase =
  ...
  const qrValue = `${base}/join`; // QR goes to APP landing page
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-emerald-50 via-white to-sky-50">
      <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        {/* Header pill */}
        <div className="mb-6 flex items-center gap-2 text-xs font-semibold tracking-wide text-emerald-700">
        ...
        <div className="overflow-hidden rounded-2xl border bg-white/90 shadow-md backdrop-blur">
          ...
          <div className="bg-emerald-600 text-white text-center px-4 py-4">
            <div className="text-sm font-semibold tracking-wide">Sunday · Nov 30, 2025</div>
